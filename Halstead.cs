...
namespace CodeAnalyser
{
    class Halstead
    {
        ...
        {
            return (this._numberOfDistinctOperators * Math.Log(this._numberOfDistinctOperators, 2) + this._numberOfDistinctOperands * Math.Log(this._numberOfDistinctOperands, 2));
        }
        ...
        public int CountTheoreticalProgramVocabulary()
        {
        ...
        public double CalculateLevelOfProgrammingQualityWithoutTpv()
        {
            return ((2 * this._numberOfDistinctOperands) / (double)(this._numberOfDistinctOperators * this._totalNumberOfOperands));
        }

        public double CalculateNumberOfRequiredElementarySolutionsForW()
        {
            return (this.CalculateTheoreticalProgramLength() * Math.Log(this.CalculateProgramVocabulary() / this.CalculateLevelOfProgrammingQuality()));
        }

        public double CalculateNumberOfRequiredElementarySolutionsForU()
        {
